...
export default class TransferHandler {
    ...
    static groupifyParameters(P: IMatchParam[] | Set<IMatchParam>): Set<ItemType | QSMatchableGroupKey>;
    ...
    static setOfFlatParams(X: ThingWithContents[]): Set<ItemType | QSMatchableGroupKey>;
