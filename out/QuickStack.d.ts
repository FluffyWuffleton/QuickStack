...
import { ILocalStorageCache } from "./IStorageCache";
...
export default class QuickStack extends Mod {
    ...
    get localStorageCache(): ILocalStorageCache;
    protected localPlayerMoved(host: Player): void;
    protected localPlayerItemAdd(host: Player): void;
    protected localPlayerItemRemove(host: Player): void;
    protected islandTileUpdated(host: Island, tile: ITile, x: number, y: number, z: number, updtype: TileUpdateType): void;
    protected itemsContainerItemAdd(host: ItemManager, item: Item, c: IContainer): void;
    protected itemsContainerItemRemove(host: ItemManager, item: Item, c: IContainer | undefined, cpos: IVector3 | undefined): void;
    ...
    private containerContentsAltered;
    private updateLSCNearbyThing;
